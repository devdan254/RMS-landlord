...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['doc_pdf'] = array(
			"title" => "{{random}}",
		...
		$this->file_upload_settings['pdf'] = array(
			"title" => "{{random}}",
			"extensions" => ".docx,.doc,.xls,.xlsx,.xml,.csv,.pdf,.xps",
			"limit" => "1",
			"filesize" => "3",
			"returnfullpath" => true,
			"filenameprefix" => "applicant",
			"uploadDir" => "uploads/files/"
		);
	

		$this->file_upload_settings['photo_video'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['cover_image'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['landing_image'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['attach'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
