                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        <input id="ctrl-fb_link"  value="<?php  echo $this->set_field_value('fb_link',""); ?>" type="url" placeholder="Copy & Paste Your Facebook Link"  name="fb_link"  class="form-control " />
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="input-group">
                                                                            <input id="ctrl-twit_link"  value="<?php  echo $this->set_field_value('twit_link',""); ?>" type="url" placeholder="Copy & Paste Your twitter Link"  name="twit_link"  class="form-control " />
                                                                                <div class="input-group-append">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="input-group">
                                                                                <input id="ctrl-insta_link"  value="<?php  echo $this->set_field_value('insta_link',""); ?>" type="url" placeholder="Copy & Paste your Instagram Link"  name="insta_link"  class="form-control " />
                                                                                    <div class="input-group-append">
                                                                    ...
                                                                    <fieldset><legend>https://noblerent.co.ke/</legend>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="input-group">
                                                                                        <input id="ctrl-domain"  value="<?php  echo $this->set_field_value('domain',""); ?>" type="text" placeholder="Name Preferred For Your Domain"  name="domain"  class="form-control " />
                                                                                            <div class="input-group-append">
