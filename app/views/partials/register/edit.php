...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('edit_register'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-national_id"  value="<?php  echo $data['national_id']; ?>" type="number" placeholder="<?php print_lang('enter_national_id'); ?>" step="1"  required="" name="national_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-phone"  value="<?php  echo $data['phone']; ?>" type="tel" placeholder="<?php print_lang('enter_phone'); ?>"  required="" name="phone"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-role"  value="<?php  echo $data['role']; ?>" type="text" placeholder="<?php print_lang('enter_role'); ?>"  required="" name="role"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
